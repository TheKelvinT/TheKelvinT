...
const Journey = () => {
  ...
  >
       ...
       <motion.p initial="hidden"
              ...
              className='mb-8 text-sm '>The timeline below is a non-exhaustive rough timeline and my learning progress. The art of technology is about how fast it changes and how it challenges us to keep up with it.</motion.p>

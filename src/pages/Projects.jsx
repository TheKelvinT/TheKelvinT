  ...
  >
        ...
        <div className='relative z-1 sm:flex hidden sm:visible'>
            ...
            <div className='h-auto w-[324.2px]'>
              ...
              className=' font-bold  text-xl md:text-2xl text-gray-50 mb-6'>NOTA Cafe Website</motion.div>
              <motion.div 
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}
          ...
          <div className='relative z-1 sm:flex hidden sm:visible'>
            ...
            <div className='h-auto w-[324.2px]'>
              ...
              className=' font-bold  text-xl md:text-2xl text-gray-50 mb-6'>Interior Design Website</motion.div>
              <motion.div 
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}

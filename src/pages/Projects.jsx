...
const projectList = [
  {
    name: "Changi Travel Circle",
    image: ctc,
    link: "https://travelcircle.changiairport.com/",
    description:'B2B and B2C Website',
    stack: ["Vue", "Typescript", "Javascript", "Element UI"]  },
  {
    name: "Changi Travel Circle CMS",
    image: ctcCMS,
    description:' Content Management System for content in Changi Travel Circle Website',
    stack: ["Vue", "Typescript", "Javascript", "Element UI"]
  },
  {
    name: "NOTA Cafe & Restaurant",
    image: nota,
...
const Projects = () => {
  ...
  >
        ...
        <div className='relative z-1 sm:flex hidden sm:visible'>
          ...
          <div className='relative z-1 sm:flex hidden sm:visible'>
            <motion.div initial="hidden"
              ...
              <img src={teckhong} alt="" className='relative h-auto sm:w-[450px] md:w-[650px] '  /> 
              <div className="absolute top-0 left-0 h-full w-full bg-black-70 opacity-70 ease-out transition duration-700    mix-blend-multiply hover:opacity-0 "></div>
            ...
            <div className='h-auto w-[324.2px]'>
              ...
              className=' font-bold  text-xl md:text-2xl text-gray-50 mb-6'>E-Commerce Website</motion.div>
              <motion.div 
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}
              ...
              className='text-start py-2 px-4 md:py-4 md:px-8 bg-black-70 mb-6 max-w-[382px] space-y-2' >
              <p >Built a fully function E-commerce website for <span className='font-bold'>Teck Hong Cold Storage</span>, a locally operated Fresh Mart at Sri Aman, Sarawak. </p>
              <p >This project is built with the driving force to lead the digital initiative within Sri Aman and with customer experience as the main priority. </p>
              </motion.div>
          ...
          <div className='relative z-1 sm:flex hidden sm:visible'>
            <motion.div initial="hidden"
              ...
              <img src={AppleRedesign} alt="" className='relative h-auto sm:w-[450px] md:w-[650px] '  /> 
              <div className="absolute top-0 left-0 h-full w-full bg-black-70 opacity-70 ease-out transition duration-700   mix-blend-multiply hover:opacity-0 "></div>
            ...
            <div className='h-auto w-[324.2px]'>
              ...
              <div className=" h-full flex flex-col justify-center text-end text-xs md:text-sm"> 
               <motion.p initial="hidden"
                  ...
                  variants={{
                    hidden: { opacity: 0, x: 75 },
                    visible: { opacity: 1 , x: 0}
                  }} className=' text-sm md:text-base font-spacemono mb-1 text-primary text-wrap'>Exercise</motion.p>
              <motion.div 
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}
              ...
              className=' font-bold  text-xl md:text-2xl text-gray-50 mb-6'>Clone Apple Website</motion.div>
              <motion.div 
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}
              ...
              className='text-start py-2 px-4 md:py-4 md:px-8 bg-black-70 mb-6 max-w-[382px]' >
              <p >The main objective of this exercise is to enhance the following skillsets such as Typescript, Redux Toolkit, Stripe Payment API, Sanity Studio as the headless CMS(backend) and Next.JS Auth .</p>
              </motion.div>
              ...
              <a href="https://github.com/TheKelvinT/Apple-Redesign" target="_blank" className='text-end'>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 0C3.58267 0 0 3.582 0 8C0 11.5347 2.292 14.5333 5.47133 15.5913C5.87067 15.6653 6 15.4173 6 15.2067V13.7173C3.77467 14.2013 3.31133 12.7733 3.31133 12.7733C2.94733 11.8487 2.42267 11.6027 2.42267 11.6027C1.69667 11.106 2.478 11.1167 2.478 11.1167C3.28133 11.1727 3.704 11.9413 3.704 11.9413C4.41733 13.164 5.57533 12.8107 6.032 12.606C6.10333 12.0893 6.31067 11.736 6.54 11.5367C4.76333 11.3333 2.89533 10.6473 2.89533 7.58267C2.89533 6.70867 3.208 5.99533 3.71933 5.43533C3.63667 5.23333 3.36267 4.41933 3.79733 3.318C3.79733 3.318 4.46933 3.10333 5.998 4.138C6.636 3.96067 7.32 3.872 8 3.86867C8.68 3.872 9.36467 3.96067 10.004 4.138C11.5313 3.10333 12.202 3.318 12.202 3.318C12.6373 4.42 12.3633 5.234 12.2807 5.43533C12.794 5.99533 13.104 6.70933 13.104 7.58267C13.104 10.6553 11.2327 11.332 9.45133 11.53C9.738 11.778 10 12.2647 10 13.0113V15.2067C10 15.4193 10.128 15.6693 10.534 15.5907C13.7107 14.5313 16 11.5333 16 8C16 3.582 12.418 0 8 0Z" fill="#C6D1F1"/>
              </svg>
              </a>
          ...
          <div className='relative z-1 sm:flex hidden sm:visible'>
            <motion.div initial="hidden"
              ...
              <img src={KyzenBina} alt="" className='relative h-auto sm:w-[450px] md:w-[650px] '  /> 
              <div className="absolute top-0 left-0 h-full w-full bg-black-70 opacity-70 ease-out transition duration-700    mix-blend-multiply hover:opacity-0 "></div>
            ...
            <div className='h-auto w-[324.2px]'>
              ...
              className=' font-bold  text-xl md:text-2xl text-gray-50 mb-6'>Interior Design Website</motion.a>
              <motion.div 
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}
              ...
              className='text-start py-2 px-4 md:py-4 md:px-8 bg-black-70 mb-6 max-w-[382px]' >
              <p>My first ever freelance project with plain HTML, CSS and Javascript. A simple landing page for the Kyzen Bina to showcase some of the past projects.</p>
              </motion.div>
              ...
              variants={{
               ...
               className='flex space-x-5 item-center justify-end'>
              <a href="https://github.com/TheKelvinT/kyzen-v2" target="_blank" className='text-end'>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 0C3.58267 0 0 3.582 0 8C0 11.5347 2.292 14.5333 5.47133 15.5913C5.87067 15.6653 6 15.4173 6 15.2067V13.7173C3.77467 14.2013 3.31133 12.7733 3.31133 12.7733C2.94733 11.8487 2.42267 11.6027 2.42267 11.6027C1.69667 11.106 2.478 11.1167 2.478 11.1167C3.28133 11.1727 3.704 11.9413 3.704 11.9413C4.41733 13.164 5.57533 12.8107 6.032 12.606C6.10333 12.0893 6.31067 11.736 6.54 11.5367C4.76333 11.3333 2.89533 10.6473 2.89533 7.58267C2.89533 6.70867 3.208 5.99533 3.71933 5.43533C3.63667 5.23333 3.36267 4.41933 3.79733 3.318C3.79733 3.318 4.46933 3.10333 5.998 4.138C6.636 3.96067 7.32 3.872 8 3.86867C8.68 3.872 9.36467 3.96067 10.004 4.138C11.5313 3.10333 12.202 3.318 12.202 3.318C12.6373 4.42 12.3633 5.234 12.2807 5.43533C12.794 5.99533 13.104 6.70933 13.104 7.58267C13.104 10.6553 11.2327 11.332 9.45133 11.53C9.738 11.778 10 12.2647 10 13.0113V15.2067C10 15.4193 10.128 15.6693 10.534 15.5907C13.7107 14.5313 16 11.5333 16 8C16 3.582 12.418 0 8 0Z" fill="#C6D1F1"/>
              </svg>
              </a>
        ...
        <motion.div initial="hidden"
            ...
            style={{ backgroundImage: `url(${nota})`, backgroundSize: "cover",backgroundPosition:"center" }}
            >
            <div 
            
            className="h-full w-full relative border-dark-gray border-[0.5px] p-6 bg-black-70 bg-opacity-70"
                  
                  >
              <div className=" text-base "> 
               <p className=' text-sm font-spacemono mb-1 text-primary'>Freelance</p>
              <h3 className=' font-bold text-2xl  text-gray-50 mb-6'>NOTA Cafe Website</h3>
            ...
            className='sm:hidden mb-6'
            style={{ backgroundImage: `url(${teckhong})`, backgroundSize: "cover",backgroundPosition:"center"  }}
            >
            <div 
            
            className="h-full w-full relative border-dark-gray border-[0.5px] p-6 bg-black-70 bg-opacity-80"
                  
                  >
              <div className=" text-base "> 
               <p className=' text-sm font-spacemono mb-1 text-primary'>Freelance</p>
              <h3 className=' font-bold text-2xl  text-gray-50 mb-6'>E-Commerce Website</h3>
              <div className='  mb-6 space-y-2' >
              <p >Built a fully function E-commerce website for <span className='font-bold'>Teck Hong Cold Storage</span>, a locally operated Fresh Mart at Sri Aman, Sarawak. </p>
              <p >This project is built with the driving force to lead the digital initiative within Sri Aman and with customer experience as the main priority. </p>
              </div>
            ...
            className='sm:hidden mb-6'
            style={{ backgroundImage: `url(${AppleRedesign})`, backgroundSize: "cover",backgroundPosition:"center" }}
            >
            <div 
            
            className="h-full w-full relative border-dark-gray border-[0.5px] p-6 bg-black-70 bg-opacity-90"
                  
                  >
              <div className=" text-base "> 
               <p className=' text-sm font-spacemono mb-1 text-primary'>Exercise</p>
              <h3 className=' font-bold text-2xl  text-gray-50 mb-6'>Clone Apple Website</h3>
              <div className='  mb-6 ' >
              <p >The main objective of this exercise is to enhance the following skillsets such as Typescript, Redux Toolkit, Stripe Payment API, Sanity Studio as the headless CMS(backend) and Next.JS Auth .</p>
              </div>
              <hr className='pt-6 border-dark-gray border-t-[0.5px] ' />
            ...
            className='sm:hidden mb-6'
            style={{ backgroundImage: `url(${KyzenBina})`, backgroundSize: "cover", backgroundPosition:"center"  }}
            >
            <div 
            ...
            className="h-full w-full relative border-dark-gray border-[0.5px] p-6 bg-black-70 bg-opacity-80"
              ...
              <div className=" text-base "> 
               <p className=' text-sm font-spacemono mb-1 text-primary'>Freelance</p>
              <h3 className=' font-bold text-2xl  text-gray-50 mb-6'>Interior Design Website</h3>
              <div className='  mb-6 space-y-2' >
              <p>My first ever freelance project. A simple landing page for the Kyzen Bina to showcase some of the past projects.</p>
              </div>
              <hr className='pt-6 border-dark-gray border-t-[0.5px] ' />

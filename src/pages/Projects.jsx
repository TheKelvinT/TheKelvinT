        ...
        <div className="h-[600vh] relative" ref={ref}>
          ...
          <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
            <motion.div style={{ x }} className="flex ">
              {/* <div className="h-screen w-screen flex items-center justify-center bg-none" /> */}
              {items.map((item) => (
                <div
                  className={`h-full w-screen flex items-center justify-center bg-none`}
                  key={item.id}
                >
                  <div className="flex flex-col gap-8 text-white">
                    <h1 className="text-xl font-bold md:text-lg lg:text-xl xl:text-xl">
                      {item.title}
                    </h1>
